...
st.set_page_config(page_title="Priceing", page_icon=":car:", initial_sidebar_state="auto", menu_items=None,layout="wide")
...
with col2: 
   ...
   ds13_model=pickle.load(open("new","rb"))
   ds13_transformer = pickle.load(open('transformer1', 'rb'))
